                    ...
                    if(selectedMajor == "คอมพิวเตอร์"){
                        ...
                        if(selectedProgram == "ปกติ"){
                            reply("● ปี 1: พื้นฐานวิศวกรรมสากล และการปรับตัว (The Learner) เรียนวิชาพื้นฐานคณะ (Calculus, Physics, Programming) เหมือนสาขาอื่น แต่เน้นภาษาอังกฤษและการทำงานร่วมกับผู้อื่น (Soft Skills)\n
                                ...
                                ● ปี 3: ปีแห่งการเจาะลึกวิชาเอกเลือก (The Deep Dive) เรียนวิชาที่ออกแบบร่วมกับบริษัทพาร์ทเนอร์ (เช่น ถ้าเลือกสาย Murata จะเน้นการผลิตและคุมคุณภาพ) เน้น "เรียนในสิ่งที่ได้ใช้" เพื่อเตรียมพร้อมเข้าทำงานจริง\n
                        ...
                        if(selectedProgram == "ปกติ"){
                            reply("● ปี 1: พื้นฐานวิศวกรรมทั่วไป และวิชาเคมีสำหรับวิศวกร เรียนวิชาพื้นฐานคณะเหมือนสาขาอื่น (Calculus 1&2, Physics 1&2, Chemistry) และเริ่มเรียนการเขียนแบบวิศวกรรม (Drawing) รวมถึงวิชาวัสดุวิศวกรรม (Engineering Materials)\n
                                ● ปี 2: วงจรไฟฟ้า (Circuit) และอุปกรณอิเล็กทรอนิกส์ เข้าสู่วิชาภาคเต็มตัว เรียนวิชา Electric Circuits 1&2, การวัดและเครื่องมือวัด (Measurements), อุปกรณ์อิเล็กทรอนิกส์ (Electronic Devices) และวิชาปราบเซียนอย่างการวิเคราะห์สัญญาณ (Signal Analysis)\n
                                ● ปี 3: ปีแห่งวิชาแกนหลัก! เรียนเครื่องจักรกลไฟฟ้า, สนามแม่เหล็ก และระบบควบคุม เรียนวิชาหนักๆ อย่างสนามแม่เหล็กไฟฟ้า (Electromagnetic Fields), เครื่องจักรกลไฟฟ้า (Electrical Machines), อิเล็กทรอนิกส์กำลัง (Power Electronics) และหลักการระบบสื่อสาร (Communication Systems)\n
                                ● ปี 4: การออกแบบระบบไฟฟ้า, โครงงานจบการศึกษา และวิชาเลือกเฉพาะสาย เน้นการออกแบบระบบไฟฟ้า (Electrical System Design), วิศวกรรมไฟฟ้าแรงสูง และทำโครงงานจบการศึกษา (Senior Project) โดยคุณสามารถเลือกเรียนเจาะจงสายได้ เช่น สายไฟฟ้ากำลัง (Power) หรือ สายสื่อสาร (Communication)");
                        }else if(selectedProgram == "พิเศษ"){
                            reply("ไม่มีสาขานี้ในภาคพิเศษครับ");
                        }else if(selectedProgram == "นานาชาติ"){
                            reply("● ปี 1: พื้นฐานวิศวกรรมสากล และการเป็นมืออาชีพ เรียน Calculus, Physics, Chemistry (ภาษาอังกฤษ) และวิชาพื้นฐานคณะอย่าง Engineering Drawing และ Principle of Being Professional เพื่อปูพื้นฐานการทำงานในระดับสากล\n
                                ● ปี 2: วงจรไฟฟ้า และฟิสิกส์อุปกรณ์ (Circuit & Devices)เรียนวิชาแกนอย่าง Electric Circuits Analysis, Electronic Engineering, สถิติวิศวกรรม และเริ่มเรียนการเขียนโปรแกรมคอมพิวเตอร์สำหรับวิศวกร (Computer Programming for Engineers)\n
                                ● ปี 3: ปีแห่งวิชาแกนไฟฟ้าและระบบอัจฉริยะ!เรียน Electrical Machines, สนามแม่เหล็กไฟฟ้า (Electromagnetic Fields), อิเล็กทรอนิกส์กำลัง (Power Electronics) และเริ่มเข้าสู่หัวใจของหลักสูตรอย่าง Smart Grid Technology และระบบควบคุม\n
                                ● ปี 4: การออกแบบระบบไฟฟ้า และเทคโนโลยีแห่งอนาคตเรียน Electrical System Design, Distributed Generation (เทคโนโลยีการผลิตไฟฟ้าแบบกระจายตัว), Electric Vehicles (EV) และทำโครงงานจบการศึกษา (Capstone Design Project) หรือเลือกออกสหกิจศึกษาในบริษัทชั้นนำ");
                        }
